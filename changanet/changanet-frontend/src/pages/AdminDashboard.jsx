...
import AdminUrgent from '../components/admin/AdminUrgent';
import AdminCharts from '../components/admin/AdminCharts';
import AdminTable from '../components/admin/AdminTable';

const AdminDashboard = () => {
  const { user } = useAuth();
  const { isAdmin, error: adminError, loading: adminLoading } = useAdmin();
          ...
          {activeTab === 'services' && (
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">Funcionalidad próximamente</h3>
                <p className="text-gray-600">La gestión de servicios se encuentra en desarrollo</p>
              </div>
            </div>
          )}
